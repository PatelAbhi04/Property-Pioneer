    ...
    <div className="bg-gray-100 py-16">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="bg-white shadow-lg rounded-lg p-8">
         ...
         <MdEmail className="mt-1.5"/>  <a  href="mailto:abhinpatel11@gmail.com?subject=Inquiry%20from%20Property%20Pioneer%20Website" className="text-blue-500 hover:underline ">abhinpatel11@gmail.com</a>
          </div>
          <div className="flex flex-row gap-4 flex-1">
         <FaTwitter className="mt-1.5"/>  <a  href="mailto:abhinpatel11@gmail.com?subject=Inquiry%20from%20Property%20Pioneer%20Website" className="text-blue-500 hover:underline ">abhinpatel11@gmail.com</a>
          </div>
          <div className="flex flex-row gap-4 flex-1">
         <FaInstagram className="mt-1.5"/>  <a  href="mailto:abhinpatel11@gmail.com?subject=Inquiry%20from%20Property%20Pioneer%20Website" className="text-blue-500 hover:underline ">abhinpatel11@gmail.com</a>
          </div>
          </div>
        </div> 
      </div>
